...
|--------|----------------------------------------|------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|
| 1      | add_comment_to_pending_review          | Add review comment to the requester's latest pending pull request review. A pending review needs to already exist to call this | owner, repo, pullNumber, path, body, subjectType   |
| 2      | add_issue_comment                      | Add a comment to a specific issue in a GitHub repository.                                                                    | owner, repo, issue_number, body                    |
| 3      | add_sub_issue                          | Add a sub-issue to a parent issue in a GitHub repository.                                                                    | owner, repo, issue_number, sub_issue_id            |
| 4      | assign_copilot_to_issue                | Assign Copilot to a specific issue in a GitHub repository.                                                                   | owner, repo, issueNumber                           |
